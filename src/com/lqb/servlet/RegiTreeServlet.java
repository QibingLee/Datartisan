...
import javax.servlet.http.HttpServletResponse;
 ...
 public class RegiTreeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*��ݲ���Ч��ѣ������ѡ�þ�̬���
		String filepath ="F://Program Files//Weka-3-4//data//zoo.arff";
		...
		writer.close();
		*/
		request.getRequestDispatcher("/WEB-INF/jsp/regitree.jsp").forward(request, response);
	}
}
