...
import com.lqb.chart.ClusterArithmetic;
 ...
 public class CluRadarServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute("polar", ari.getPolar());
			request.setAttribute("radar",ari.getPointData());
			request.setAttribute("tag", "true");
			request.getRequestDispatcher("/WEB-INF/jsp/radarcluster.jsp").forward(request, response);
		} catch (Exception e) {
