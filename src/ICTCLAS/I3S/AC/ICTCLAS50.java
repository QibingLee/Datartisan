...
public class ICTCLAS50
{
	...
	static
	{
		//System.out.println(new File("").getAbsolutePath()+"\\ICTCLASConf\\ICTCLAS50.dll");
	//	System.loadLibrary(new File("").getAbsolutePath()+"\\ICTCLASConf\\");
		System.out.println(new File(""));
		System.load(new File("").getAbsolutePath()+"\\ICTCLASConf\\ICTCLAS50.dll");
	}
