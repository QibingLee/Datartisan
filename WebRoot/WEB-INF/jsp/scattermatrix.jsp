...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="css/styley.css"/>
    <style type="text/css">
body{
...
d3.csv("data/distribution.csv", function(flowers) {

  // Size parameters.
  var size = 140,
      padding = 10,
      n = 4,
      traits = [<%=request.getAttribute("attsel")%>];
  ...
  var legend = svg.selectAll("g.legend")
    ...
    .enter().append("svg:g")
      .attr("class", "legend")
      .attr("transform", function(d, i) { return "translate(20," + (i * 20 + 594) + ")"; });
